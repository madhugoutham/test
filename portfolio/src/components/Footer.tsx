    ...
    <footer className="bg-gray-900 text-white pt-12 pb-6">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="mb-6 md:mb-0">
            <h2 className="text-2xl font-bold">
              <span className="text-primary">Madhu</span> Goutham Reddy
            </h2>
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6">
            ...
            <Link
              ...
              smooth={true}
              duration={500}
              className="bg-primary text-white p-2 rounded-full hover:bg-secondary transition-colors cursor-pointer"
        ...
        <div className="border-t border-gray-800 pt-6 text-center text-gray-400 text-sm">
          <p>&copy; {currentYear} Madhu Goutham Reddy Ambati. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
